...
var countdownInterval; // Variável para armazenar o identificador do intervalo de contagem regressiva
...
function showPopunder() {
    ...
    if (!isVideoOpen) {
        ...
        document.getElementById('rewardMessage').innerHTML = 'Assista aos anúncios e veja o resultado';
...
function closePopunder() {
    ...
    // Limpa o intervalo da contagem regressiva, se existir
...
function startRewardCountdown() {
    ...
    countdownInterval = setInterval(function() {
        ...
        if (count < 0) {
            ...
            setTimeout(closePopunder, 2000); // Fecha o popunder após 2 segundos
        }
